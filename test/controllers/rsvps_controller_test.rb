...
class RsvpsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create rsvp" do
    assert_difference('Rsvp.count') do
      post rsvps_url, params: { rsvp: { attending: @rsvp.attending, contact_number: @rsvp.contact_number, name: @rsvp.name, number_of_guests: @rsvp.number_of_guests } }
    end
  ...
  test "should update rsvp" do
    patch rsvp_url(@rsvp), params: { rsvp: { attending: @rsvp.attending, contact_number: @rsvp.contact_number, name: @rsvp.name, number_of_guests: @rsvp.number_of_guests } }
